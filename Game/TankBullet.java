...
public class TankBullet extends Thread{
   ...
   public TankBullet (TileMap t, int xPos, int yPos, LinkedList sprites, Player player){
        map = t;
        ...
        bulletImage = ImageManager.loadImage("images/TankBullet.jpg");
        dx=2;
        dy=10;
        
       if (!tank.faceRightDirection())
            dx = -dx;;
    }
    ...
    */
   public static boolean collidesWithtankAndBullet(Tank tank, TankBullet bullet) {
